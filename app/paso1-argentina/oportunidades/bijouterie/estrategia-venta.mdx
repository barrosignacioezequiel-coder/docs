...
```mermaid
graph TD
    A["Publicás contenido<br/>en feed/reels"] --> B["Persona interesada<br/>te escribe por DM"]
    B --> C["Mandás catálogo<br/>con precios"]
    C --> D["Elige productos<br/>y confirma pedido"]
    D --> E["Cobrás por<br/>transferencia/MP"]
    E --> F["Enviás por correo<br/>o acordás entrega"]
    F --> G["Pedís foto/review<br/>para prueba social"]
    G --> A
```
