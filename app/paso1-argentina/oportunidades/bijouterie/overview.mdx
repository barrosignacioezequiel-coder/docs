...
```mermaid
graph TD
    A["Encontrar proveedores<br/>en Once/Flores"] --> B["Primera compra<br/>$30-80k ARS"]
    B --> C["Fotografía de<br/>productos"]
    C --> D["Publicar en<br/>MercadoLibre"]
    D --> E["Primeras ventas<br/> y feedback"]
    E --> F{"¿Qué se<br/>vende más?"}
    F --> G["Reponer stock<br/>de ganadores"]
    F --> H["Descartar<br/>modelos flojos"]
    G --> I["Reinvertir<br/>ganancias"]
    I --> J["Escalar:<br/>más stock + Instagram"]
    J --> K["Puente a<br/>importación China"]
```
