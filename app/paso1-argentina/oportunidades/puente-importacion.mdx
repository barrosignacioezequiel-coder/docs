...
```mermaid
graph LR
    A["Mes 1-2:<br/>Primeras compras<br/>locales"] --> B["Mes 3-4:<br/>Ventas estables<br/>+100 ventas ML"]
    B --> C["Mes 5-6:<br/>Investigar<br/>Alibaba"]
    C --> D["Mes 7-8:<br/>Pedir muestras<br/>de China"]
    D --> E["Mes 9-10:<br/>Evaluar y<br/>calcular costos"]
    E --> F["Mes 11-12:<br/>Primer pedido<br/>de importacion"]
    F --> G["Mes 13-15:<br/>Recibir mercaderia<br/>y validar"]
```
...
```mermaid
graph TD
    A["PASO 1<br/>Comprar en fabricas<br/>argentinas"] --> B["Aprender a vender<br/>Contar tu mercado<br/>Construir reputacion"]
    B --> C["Cumplir los 5 hitos<br/>de transicion"]
    C --> D["TRANSICION<br/>Investigar China<br/>Pedir muestras<br/>Calcular costos"]
    D --> E["PASO 2<br/>Importar de China<br/>Directo de fabrica"]
    E --> F["Escalar el negocio<br/>Mas productos<br/>Mas volumen"]
```
