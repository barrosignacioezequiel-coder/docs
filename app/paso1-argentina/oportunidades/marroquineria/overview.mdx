...
```mermaid
graph TD
    A["Empezás vendiendo<br/>productos genéricos"] --> B["Identificás qué<br/>se vende más"]
    B --> C["Contactás fábrica<br/>que personaliza"]
    C --> D{"¿Qué personalización?"}
    D --> E["Logo grabado<br/>en el producto"]
    D --> F["Etiqueta interior<br/>con tu marca"]
    D --> G["Color/material<br/>exclusivo"]
    E --> H["Vendés con<br/>tu marca propia"]
    F --> H
    G --> H
    H --> I["Registrás la marca<br/>en INPI"]
    I --> J["Escala: tienda propia<br/>+ marca posicionada"]
```
