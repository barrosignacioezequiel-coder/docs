...
```mermaid
graph LR
    A["Mes 1-3<br/>Sin marca<br/>Validar mercado"] --> B["Mes 3-6<br/>Marca básica<br/>Nombre + logo"]
    B --> C["Mes 6-12<br/>Marca personalizada<br/>Productos grabados"]
    C --> D["Mes 12+<br/>Marca posicionada<br/>Tienda propia"]
```
