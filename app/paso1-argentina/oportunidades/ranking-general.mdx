...
graph TD
    subgraph "Score 8+"
    A["#1 Bijouterie<br/>8.23"]
    end
    subgraph "Score 7.5 - 8.0"
    B["#2 Fitness<br/>7.88"]
    C["#3 Papeleria<br/>7.67"]
    D["#4 Mascotas<br/>7.52"]
    end
    subgraph "Score 7.0 - 7.5"
    E["#5 Decoracion<br/>7.36"]
    F["#6 Marroquineria<br/>7.33"]
    G["#7 Packaging<br/>7.22"]
    H["#8 Bazar<br/>7.17"]
    end
```
...
```mermaid
graph TD
    A["Cuanto capital<br/>tenes?"] --> B{"< $100k ARS?"}
    A --> C{"> $100k ARS?"}
    B --> D["Bijouterie<br/>o Packaging"]
    C --> E{"Te gusta<br/>el diseño?"}
    E --> F["Si: Decoracion<br/>o Marroquineria"]
    E --> G{"Importar<br/>es tu meta?"}
    G --> H["Si: Fitness<br/>o Bijouterie"]
    G --> I{"Mercado en<br/>crecimiento?"}
    I --> J["Si: Mascotas<br/>o Bazar"]
    I --> K["Papeleria:<br/>seguro y estable"]
```
