...
```mermaid
graph LR
    A["Mes 1-2:<br/>Items sueltos<br/>en un sub-nicho"] --> B["Mes 3-4:<br/>Armar sets<br/>y combos"]
    B --> C["Mes 5-6:<br/>Instagram<br/>+ Fotos pro"]
    C --> D["Mes 7-9:<br/>Marca propia<br/>en packaging"]
    D --> E["Mes 10-12:<br/>Importar<br/>de China"]
```
