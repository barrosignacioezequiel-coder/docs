...
```mermaid
graph TD
    A["Elegir sub-nicho<br/>de bazar"] --> B["Visitar mayoristas<br/>en Avellaneda/Once"]
    B --> C["Primera compra<br/>$100-200k ARS"]
    C --> D["Fotos profesionales<br/>'en contexto de uso'"]
    D --> E["Publicar en ML<br/>con medidas y detalles"]
    E --> F["Primeras ventas<br/>y feedback"]
    F --> G{"Que sub-nicho<br/>funciona mejor?"}
    G --> H["Profundizar nicho<br/>ganador"]
    G --> I["Descartar productos<br/>lentos"]
    H --> J["Armar sets y combos<br/>subir ticket promedio"]
    J --> K["Escalar: mas stock<br/>+ Instagram"]
    K --> L["Puente a China:<br/>importar los ganadores"]
```
