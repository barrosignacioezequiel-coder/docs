...
```mermaid
graph TD
    A["Tu stock de<br/>packaging"] --> B["B2C: Consumidor final"]
    A --> C["B2B: Emprendedores"]
    B --> D["Cajas de regalo<br/>Papel de envolver<br/>Moños"]
    C --> E["Kits packaging<br/>Stickers marca<br/>Cajas para envios"]
    D --> F["MercadoLibre<br/>Instagram"]
    E --> G["MercadoLibre<br/>Contacto directo<br/>Instagram"]
```
...
```mermaid
graph LR
    A["Mes 1-2:<br/>Packaging liso<br/>basico"] --> B["Mes 3-4:<br/>Stickers propios<br/>Kits armados"]
    B --> C["Mes 5-6:<br/>Clientes B2B<br/>Recurrentes"]
    C --> D["Mes 7-9:<br/>Personalizacion<br/>con logo"]
    D --> E["Mes 10-12:<br/>Importacion<br/>de China"]
```
