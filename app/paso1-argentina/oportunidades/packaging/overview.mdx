...
```mermaid
graph TD
    A["Contactar imprentas<br/>y cartonerias"] --> B["Primera compra<br/>$50-100k ARS"]
    B --> C["Fotografiar productos<br/>en contexto de uso"]
    C --> D["Publicar en ML:<br/>B2C + B2B"]
    D --> E["Primeras ventas<br/>y feedback"]
    E --> F{"Que se<br/>vende mas?"}
    F --> G["Reponer stock<br/>de ganadores"]
    F --> H["Ajustar surtido"]
    G --> I["Armar kits<br/>emprendedor"]
    I --> J["Escalar: stickers<br/>personalizados"]
    J --> K["Puente a China:<br/>packaging importado"]
```
