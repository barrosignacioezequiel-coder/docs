...
```mermaid
graph TD
    A["Vendés un producto"] --> B{"¿Qué modalidad<br/>de envío?"}
    B --> C["Flex<br/>24-48hs AMBA"]
    B --> D["Colecta<br/>Recolección a domicilio"]
    B --> E["Full<br/>Stock en depósito ML"]

    C --> F["Vos entregás<br/>al comprador o punto"]
    D --> G["ML manda a buscar<br/>el paquete a tu casa"]
    E --> H["ML almacena, empaca<br/>y envía por vos"]
...
```mermaid
graph LR
    A["Precio venta<br/>ARS 12,000"] --> B["Comisión ML<br/>- ARS 1,560"]
    B --> C["Envío<br/>- ARS 1,200"]
    C --> D["Impuestos<br/>- ARS 480"]
    D --> E["Packaging<br/>- ARS 300"]
    E --> F["Costo producto<br/>- ARS 5,000"]
    F --> G["Ganancia neta<br/>ARS 4,460"]
