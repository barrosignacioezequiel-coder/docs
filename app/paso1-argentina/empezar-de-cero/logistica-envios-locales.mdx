...
```mermaid
graph TD
    A["Necesitás enviar<br/>un producto"] --> B{"¿Vendés por<br/>MercadoLibre?"}
    B -->|"Sí"| C["MercadoEnvíos<br/>Flex / Colecta / Full"]
    B -->|"No / Tienda propia"| D{"¿Dónde está<br/>el comprador?"}
    D -->|AMBA| E["Moto cadete<br/>24-48hs"]
    D -->|Interior| F{"¿Prioridad?"}
    F -->|Velocidad| G["Operador privado<br/>Andreani / OCA"]
    F -->|Precio| H["Correo Argentino<br/>Paq.Ar"]
