...
```mermaid
graph TD
    A["Fábrica"] -->|"Exclusividad<br/>y mejores precios"| B["Vos<br/>(representante)"]
    B -->|"Vendés en<br/>tu territorio"| C["Clientes B2B<br/>en tu zona"]
    B -->|"Vendés por<br/>tu canal"| D["Canal online<br/>(ML, tienda)"]
    B -->|"Reportás ventas<br/>y feedback"| A

    A -->|"Soporte:<br/>material, capacitación,<br/>productos nuevos"| B
