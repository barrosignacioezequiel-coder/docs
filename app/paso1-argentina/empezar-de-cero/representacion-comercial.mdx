...
```mermaid
graph TD
    A["Fábrica"] -->|"Exclusividad y mejores precios"| B["Vos<br/>(representante)"]
    B -->|"Vendés en tu territorio"| C["Clientes B2B<br/>en tu zona"]
    B -->|"Vendés por tu canal"| D["Canal online<br/>(ML, tienda)"]
    B -->|"Reportás ventas y feedback"| A

    A -->|"Soporte: material, capacitación, productos nuevos"| B
