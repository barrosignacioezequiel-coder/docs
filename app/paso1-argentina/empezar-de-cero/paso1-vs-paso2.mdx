...
```mermaid
graph TD
    A["Investigar productos"] --> B["Armar infraestructura"]
    B --> C["Primera compra a fábrica"]
    C --> D["Vender y aprender"]
    D --> E["Reinvertir y crecer"]
    E --> F["Ventas estables"]
    F --> G["Consolidar negocio local"]
    G --> H["Acumular capital"]
    H --> I["Estudiar importación"]
    I --> J["Primera importación"]
    J --> K["Escalar con China + local"]
