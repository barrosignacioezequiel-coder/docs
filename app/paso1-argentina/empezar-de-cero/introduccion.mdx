...
```mermaid
graph TD
    A["Investigar productos<br/>y mercado"] --> B["Encontrar una<br/>fábrica argentina"]
    B --> C["Hacer tu primera<br/>compra mayorista"]
    C --> D["Vender y aprender<br/>qué funciona"]
    D --> E["Reinvertir<br/>las ganancias"]
    E --> F["Escalar el negocio<br/>local"]
    F --> G["Paso 2:<br/>Importar de China"]
