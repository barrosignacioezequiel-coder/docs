...
```mermaid
graph TD
    A["¿Tenés capital<br/>para comprar stock?"] -->|"Sí<br/>(ARS 100,000+)"| B["¿Querés manejar<br/>stock físico?"]
    A -->|"No<br/>(ARS 0-30,000)"| C["¿Tenés tiempo<br/>para vender?"]

    B -->|"Sí"| D["¿Querés tu<br/>propia marca?"]
    B -->|"No"| E["Dropshipping local"]

    C -->|"Sí"| F["Consignación"]
    C -->|"No"| G["Dropshipping local"]

    D -->|"Sí"| H["Marca propia<br/>(private label)"]
    D -->|"No"| I["¿Vendés a<br/>consumidores o<br/>a negocios?"]

    I -->|"Consumidores<br/>(B2C)"| J["Reventa directa"]
    I -->|"Negocios<br/>(B2B)"| K["Distribución B2B"]
...
```mermaid
graph LR
    A["Mes 1-3<br/>Reventa directa<br/>+ Consignación"] --> B["Mes 4-6<br/>Reventa optimizada<br/>+ Servicios"]
    B --> C["Mes 7-12<br/>Marca propia<br/>+ B2B"]
    C --> D["Año 2+<br/>Representación<br/>+ Importación"]
