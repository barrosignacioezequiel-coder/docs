...
```mermaid
graph TD
    A["¿Tenés capital<br/>para comprar stock?"] -->|"Sí (ARS 100,000+)"| B["¿Querés manejar<br/>stock físico?"]
    A -->|"No (ARS 0-30,000)"| C["¿Tenés tiempo<br/>para vender?"]
    ...
    I -->|"Consumidores (B2C)"| J["Reventa directa"]
    I -->|"Negocios (B2B)"| K["Distribución B2B"]
