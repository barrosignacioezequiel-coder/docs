...
```mermaid
graph TD
    A["Te inscribís en<br/>Monotributo o RI"] --> B["Obligaciones<br/>mensuales"]
    B --> C["Pagar cuota<br/>monotributo"]
    B --> D["Presentar DDJJ<br/>de IIBB"]
    B --> E["Facturar<br/>correctamente"]
    B --> F["Recategorizarte<br/>cada 6 meses"]

    C --> G{"¿Lo hacés<br/>bien?"}
    D --> G
    E --> G
    F --> G

    G -->|No| H["Multas, intimaciones<br/>y problemas con AFIP"]
    G -->|"Sí"| I["Negocio en regla<br/>sin sorpresas"]
