...
```mermaid
graph TD
    A["Capital inicial<br/>ARS 100,000-300,000"] --> B["Primera compra<br/>de mercadería"]
    A --> C["Materiales<br/>de packaging"]
    A --> D["Fotos y<br/>contenido"]
    A --> E["Costos fijos<br/>mensuales"]

    B --> F["50-60% del capital"]
    C --> G["5-10% del capital"]
    D --> H["3-5% del capital"]
    E --> I["30-40% del capital<br/>(2-3 meses de reserva)"]
...
```mermaid
graph LR
    A["Mes 1<br/>Inversión<br/>ARS 200,000<br/>5-10 ventas"] --> B["Mes 2<br/>Ajustes<br/>15-25 ventas<br/>Aprendiendo"]
    B --> C["Mes 3<br/>Tracción<br/>30-50 ventas<br/>Primera recompra"]
    C --> D["Mes 4-5<br/>Equilibrio<br/>50-80 ventas<br/>Cubrís costos"]
    D --> E["Mes 6+<br/>Ganancia<br/>80+ ventas<br/>Reinvertís"]

    style A fill:#e53935,stroke:#c62828,color:#fff
    style B fill:#ff9800,stroke:#ef6c00,color:#fff
    style C fill:#fff9c4,stroke:#f9a825,color:#fff
