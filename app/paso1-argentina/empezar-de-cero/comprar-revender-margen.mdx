...
```mermaid
graph TD
    A["Comprás a fábrica<br/>ARS 3,000"] --> B["Publicás en ML<br/>a ARS 8,500"]
    B --> C["Se vende"]
    C --> D["ML cobra comisión<br/>-ARS 1,445"]
    D --> E["Preparás el envío<br/>Packaging -ARS 300"]
    E --> F["Pagás impuestos<br/>IIBB -ARS 298"]
    F --> G["Ganancia neta<br/>ARS 3,457/unidad"]
    ...
    style F fill:#ffebee,stroke:#c62828,color:#fff
