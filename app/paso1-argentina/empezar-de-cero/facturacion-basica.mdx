...
```mermaid
graph TD
    A["Realizas una venta"] --> B{"Monto mayor a<br/>$75.000 aprox.?"}
    B -- No --> C["Factura C a<br/>Consumidor Final<br/>(sin CUIT del comprador)"]
    B -- Si --> D["Factura C con<br/>CUIT/DNI del comprador"]
    C --> E["Emitir por<br/>ARCA / App"]
    D --> E
    E --> F["ARCA genera CAE"]
    F --> G["Enviar factura<br/>al comprador"]
```
