...
```mermaid
graph TD
    A["Vos publicás<br/>el producto<br/>en ML o tu tienda"] -->|"1. Cliente<br/>compra"| B["Recibís<br/>el pedido"]
    B -->|"2. Le pasás<br/>el pedido al<br/>proveedor"| C["Proveedor<br/>argentino"]
    C -->|"3. Envía directo<br/>al cliente"| D["Cliente<br/>recibe"]
    D -->|"4. Si hay problema,<br/>el cliente te<br/>reclama a vos"| A
