...
```mermaid
graph TD
    A["Vos publicás<br/>el producto<br/>en ML o tu tienda"] -->|"1. Cliente compra"| B["Recibís<br/>el pedido"]
    B -->|"2. Le pasás el pedido al proveedor"| C["Proveedor<br/>argentino"]
    C -->|"3. Envía directo al cliente"| D["Cliente<br/>recibe"]
    D -->|"4. Si hay problema, el cliente te reclama a vos"| A
