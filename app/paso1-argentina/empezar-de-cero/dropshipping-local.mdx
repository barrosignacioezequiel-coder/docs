...
```mermaid
graph TD
    A["Vos publicás<br/>el producto<br/>en ML o tu tienda"] -->|"Cliente compra"| B["Recibís<br/>el pedido"]
    B -->|"Le pasás el pedido al proveedor"| C["Proveedor<br/>argentino"]
    C -->|"Envía directo al cliente"| D["Cliente<br/>recibe"]
    D -->|"Si hay problema, el cliente te reclama a vos"| A
