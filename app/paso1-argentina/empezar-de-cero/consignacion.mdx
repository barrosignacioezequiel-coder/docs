...
```mermaid
graph TD
    A["Fábrica<br/>(consignante)"] -->|"1. Entrega<br/>productos"| B["Vos<br/>(consignatario)"]
    B -->|"2. Vendés al<br/>consumidor"| C["Cliente<br/>final"]
    C -->|"3. Pagó<br/>el producto"| B
    B -->|"4. Liquidás ventas<br/>(periódicamente)"| A
    B -->|"5. Devolvés<br/>lo no vendido"| A
