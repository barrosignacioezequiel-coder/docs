...
```mermaid
graph TD
    A["Fábrica<br/>(consignante)"] -->|"Entrega productos"| B["Vos<br/>(consignatario)"]
    B -->|"Vendés al consumidor"| C["Cliente<br/>final"]
    C -->|"Pagó el producto"| B
    B -->|"Liquidás ventas (periódicamente)"| A
    B -->|"Devolvés lo no vendido"| A
