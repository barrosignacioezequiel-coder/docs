...
```mermaid
graph TD
    A["Fábrica"] -->|"Comprás a<br/>precio mayorista"| B["Vos<br/>(distribuidor)"]
    B -->|"Vendés a<br/>precio intermedio"| C["Revendedores ML"]
    B -->|"Vendés a<br/>precio intermedio"| D["Locales físicos"]
    B -->|"Vendés<br/>por cantidad"| E["Empresas<br/>(corporativo)"]
    B -->|"Vendés a<br/>precio intermedio"| F["Otros canales<br/>minoristas"]

    C -->|"Vende al<br/>consumidor final"| G["Cliente final"]
    D -->|"Vende al<br/>consumidor final"| G
    F -->|"Vende al<br/>consumidor final"| G
...
```mermaid
graph LR
    A["Mes 1-3<br/>Revendedor B2C<br/>100 ventas/mes<br/>Margen 35%"] --> B["Mes 4-6<br/>B2C + primeros<br/>clientes B2B<br/>80 B2C + 2 B2B"]
    B --> C["Mes 7-12<br/>50% B2C<br/>50% B2B<br/>Ingresos estables"]
    C --> D["Año 2<br/>Distribuidor<br/>zonal<br/>+10 clientes B2B"]
