...
```mermaid
graph TD
    A["Fábrica"] -->|"Comprás a precio mayorista"| B["Vos<br/>(distribuidor)"]
    B -->|"Vendés a precio intermedio"| C["Revendedores ML"]
    B -->|"Vendés a precio intermedio"| D["Locales físicos"]
    B -->|"Vendés por cantidad"| E["Empresas<br/>(corporativo)"]
    B -->|"Vendés a precio intermedio"| F["Otros canales<br/>minoristas"]

    C -->|"Vende al consumidor final"| G["Cliente final"]
    D -->|"Vende al consumidor final"| G
    F -->|"Vende al consumidor final"| G
