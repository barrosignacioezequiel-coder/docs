...
```mermaid
graph TD
    A["MercadoLibre<br/>Canal de captación"] --> B["Comprador descubre<br/>tu producto"]
    B --> C["Recibe el producto<br/>+ tarjeta con tu marca"]
    C --> D["Visita tu tienda<br/>online o Instagram"]
    D --> E["Compra directo<br/>en tu tienda"]
    E --> F["Menor comisión<br/>Más margen"]
    F --> G["Cliente recurrente<br/>de tu marca"]
