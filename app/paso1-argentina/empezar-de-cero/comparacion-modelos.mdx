...
```mermaid
graph TD
    A["¿Cuánto capital<br/>tenés?"] -->|"ARS 0-30,000"| B["¿Querés manejar<br/>envíos?"]
    A -->|"ARS 100,000-300,000"| C["¿Tenés experiencia<br/>vendiendo?"]
    A -->|"ARS 300,000+"| D["¿Querés construir<br/>marca?"]

    B -->|"Sí"| E["Consignación"]
    B -->|"No"| F["Dropshipping local"]

    C -->|"No, empiezo"| G["Reventa directa"]
    C -->|"Sí, 3+ meses"| H["Reventa + Servicios<br/>complementarios"]

    D -->|"Sí"| I["Marca propia"]
    D -->|"No, prefiero<br/>volumen"| J["Distribución B2B"]

    E -->|"Cuando juntés<br/>capital"| G
    F -->|"Cuando juntés<br/>capital"| G
    G -->|"Cuando tengas<br/>6+ meses"| K["Representación<br/>comercial"]
    H -->|"Evolución<br/>natural"| I
    J -->|"Con relación<br/>con fábrica"| K
...
```mermaid
graph TD
    A["MES 1-2<br/>Arrancá con<br/>Reventa directa<br/>o Consignación"] --> B["MES 3-4<br/>Optimizá:<br/>mejor stock,<br/>mejor pricing"]
    B --> C["MES 5-6<br/>Agregá:<br/>Servicios<br/>complementarios"]
    C --> D["MES 7-12<br/>Escalá:<br/>Marca propia<br/>o B2B"]
    D --> E["AÑO 2<br/>Consolidá:<br/>Representación<br/>o Importación"]
