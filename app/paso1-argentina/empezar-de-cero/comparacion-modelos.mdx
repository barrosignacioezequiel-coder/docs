...
graph TD
    ...
    D -->|Sí| I["Marca propia"]
    D -->|No, prefiero volumen| J["Distribución B2B"]

    E -->|Cuando juntés capital| G
    F -->|Cuando juntés capital| G
    G -->|Cuando tengas 6+ meses| K["Representación<br/>comercial"]
    H -->|Evolución natural| I
    J -->|Con relación con fábrica| K
