...
```mermaid
graph TD
    A["Productos genéricos<br/>de fábricas"] -->|"Kitting"| B["Combos<br/>temáticos"]
    A -->|"Curación"| C["Sets<br/>coordinados"]
    A -->|"Personalización"| D["Productos<br/>customizados"]
    A -->|"Packaging<br/>premium"| E["Presentación<br/>de regalo"]

    B --> F["Mayor valor<br/>percibido<br/>+30-50% ticket"]
    C --> F
    D --> F
    E --> F
