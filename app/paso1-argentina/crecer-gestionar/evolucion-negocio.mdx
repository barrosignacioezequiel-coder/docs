...
```mermaid
graph LR
    A["Etapa 1<br/>Reventa genérica<br/>Mes 1-6"] --> B["Etapa 2<br/>Selección curada<br/>Mes 3-9"]
    B --> C["Etapa 3<br/>Marca propia<br/>Mes 6-18"]
    C --> D["Etapa 4<br/>Distribución<br/>Mes 12+"]
    D --> E["Etapa 5<br/>Producción propia<br/>Año 2+"]
