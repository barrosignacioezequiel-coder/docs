...
```mermaid
graph TD
    A["Capital total<br/>disponible"] --> B["70% Rubro principal<br/>Producto probado<br/>Stock asegurado<br/>No arriesgar lo que funciona"]
    A --> C["30% Rubro nuevo<br/>Compra de prueba<br/>Fotos y publicaciones<br/>Testar demanda"]

    B --> D["Mantener stock<br/>de productos A<br/>Nunca quedarte<br/>sin tu estrella"]
    C --> E["Compra chica<br/>3-5 productos<br/>20-30 unidades<br/>cada uno"]
...
```mermaid
graph TD
    A["Quiero agregar<br/>un segundo rubro"] --> B{"Tu primer rubro<br/>es estable 3+ meses?"}
    B -->|No| C["Todavía no.<br/>Estabilizá primero"]
    B -->|"Sí"| D{"Margen neto<br/>25%+ sostenido?"}
    D -->|No| E["Mejorá márgenes<br/>antes de expandir"]
    D -->|"Sí"| F{"Tenés capital<br/>excedente 30%+?"}
    F -->|No| G["Ahorrá hasta tener<br/>capital para testear"]
    F -->|"Sí"| H{"Tenés tiempo<br/>o ayuda?"}
    H -->|No| I["Contratá ayuda<br/>primero"]
    H -->|"Sí"| J["Elegí rubro<br/>complementario<br/>y testeá con 30%<br/>del capital"]

    style C fill:#ffebee,stroke:#c62828,color:#fff
    style E fill:#ffebee,stroke:#c62828,color:#fff
