...
```mermaid
graph TD
    A["0-30 ventas/mes<br/>Planilla Google Sheets<br/>Facturación ARCA<br/>Celular para fotos"] --> B["30-80 ventas/mes<br/>App de facturación<br/>Planilla mejorada<br/>Mini estudio foto"]
    B --> C["80-200 ventas/mes<br/>ERP básico<br/>Gestión de envíos<br/>Fotografía semi-pro"]
    C --> D["200+ ventas/mes<br/>ERP completo<br/>Integración ML<br/>Procesos automatizados"]
