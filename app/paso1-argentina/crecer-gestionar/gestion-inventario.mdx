...
```mermaid
graph TD
    A["Tu catálogo<br/>completo"] --> B["Productos A<br/>20% del catálogo<br/>80% de ventas"]
    A --> C["Productos B<br/>30% del catálogo<br/>15% de ventas"]
    A --> D["Productos C<br/>50% del catálogo<br/>5% de ventas"]

    B --> E["Nunca sin stock<br/>Mejor packaging<br/>Más inversión"]
    C --> F["Stock moderado<br/>Monitoreo mensual<br/>Optimizar precio"]
    D --> G["Liquidar o discontinuar<br/>Liberar capital<br/>Probar reemplazo"]
