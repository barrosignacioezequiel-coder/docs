...
```mermaid
graph LR
    A["Producto A<br/>Se vende solo<br/>ARS 3,500"] --> D["Kit<br/>A + C<br/>ARS 4,800"]
    B["Producto C<br/>No se vende<br/>ARS 2,000"] --> D
    D --> E["Cliente percibe<br/>valor: ARS 5,500<br/>Paga: ARS 4,800<br/>Ahorro: ARS 700"]
    D --> F["Vos movés<br/>stock parado<br/>y ganás más<br/>que vendiendo<br/>A solo"]

    style A fill:#4caf50,stroke:#2e7d32,color:#fff
    style B fill:#ffebee,stroke:#c62828,color:#fff
