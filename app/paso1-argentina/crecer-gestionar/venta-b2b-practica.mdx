...
```mermaid
graph TD
    A["Tu emprendimiento"] --> B["Revendedores<br/>online"]
    A --> C["Tiendas<br/>físicas"]
    A --> D["Empresas<br/>(corporativos)"]

    B --> B1["Te compran<br/>por mayor<br/>y venden en ML"]
    C --> C1["Exhiben tus<br/>productos<br/>en su local"]
    D --> D1["Compran lotes<br/>para regalos<br/>o uso interno"]
...
```mermaid
graph TD
    A["Ingreso total<br/>de tu emprendimiento"] --> B["Venta minorista<br/>(ML + Instagram)<br/>60-70%"]
    A --> C["Venta B2B<br/>(mayorista)<br/>30-40%"]
    B --> B1["Variable<br/>Depende de<br/>temporada y<br/>competencia"]
    C --> C1["Estable<br/>Pedidos<br/>recurrentes<br/>de clientes fijos"]
