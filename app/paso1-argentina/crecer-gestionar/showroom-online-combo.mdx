...
```mermaid
graph TD
    A["Instagram / ML<br/>Genera interés"] -->|"El cliente quiere ver el producto"| B["WhatsApp<br/>Coordina turno"]
    B --> C["Showroom<br/>Cliente visita<br/>ve y toca"]
    C -->|"Compra en el momento"| D["Venta cerrada<br/>Ticket más alto"]
    C -->|"No compra pero conoce"| E["Seguimiento<br/>por WhatsApp"]
    E -->|"Compra después online"| F["Venta por ML<br/>o transferencia"]
