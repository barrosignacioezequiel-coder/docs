...
```mermaid
graph TD
    A["Instagram / ML<br/>Genera interés"] -->|"El cliente quiere<br/>ver el producto"| B["WhatsApp<br/>Coordina turno"]
    B --> C["Showroom<br/>Cliente visita<br/>ve y toca"]
    C -->|"Compra en<br/>el momento"| D["Venta cerrada<br/>Ticket más alto"]
    C -->|"No compra<br/>pero conoce"| E["Seguimiento<br/>por WhatsApp"]
    E -->|"Compra<br/>después online"| F["Venta por ML<br/>o transferencia"]
