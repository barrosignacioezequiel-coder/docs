...
```mermaid
graph TD
    A["Facturación<br/>mensual total"] --> B{"Es mayor a<br/>ARS 4M?"}
    B -->|"Sí"| C["El local<br/>genera ganancia"]
    B -->|"No"| D["El local<br/>te da pérdida"]
    C --> E["Asegurate que al menos<br/>30% viene del local"]
    D --> F["Mejor seguir<br/>con canales online<br/>y showroom"]

    style A fill:#2196f3,stroke:#1565c0,color:#fff
    style C fill:#4caf50,stroke:#2e7d32,color:#fff
    style D fill:#ffebee,stroke:#c62828,color:#fff
...
```mermaid
graph TD
    A["MercadoLibre<br/>Alcance nacional<br/>60% de ventas"] --> D["Tu marca"]
    B["Instagram<br/>Construcción de marca<br/>20% de ventas"] --> D
    C["Local físico<br/>Experiencia presencial<br/>20% de ventas"] --> D

    D --> E["Cliente compra<br/>en cualquier canal"]
    E -->|"Conoció en ML"| C
    E -->|"Vio en el local"| A
    E -->|"Siguió en IG"| B
