...
```mermaid
graph TD
    A["Sueldo bruto<br/>ARS 300,000"] --> B["Cargas sociales<br/>+45% = ARS 135,000"]
    B --> C["Costo mensual<br/>ARS 435,000"]
    C --> D["Costo anual<br/>13 meses<br/>ARS 5,670,000"]
    D --> E["Costo por hora<br/>~ARS 2,500<br/>(176 hs/mes)"]
