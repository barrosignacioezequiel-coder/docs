...
```mermaid
graph LR
    A["Vos<br/>(proveedor)"] -->|"1) Entregás productos"| B["Tienda<br/>(exhibe y vende)"]
    B -->|"2) Cliente compra"| C["Venta<br/>realizada"]
    C -->|"3) Liquidación mensual"| A
    B -->|"4) Devuelve lo no vendido"| A
