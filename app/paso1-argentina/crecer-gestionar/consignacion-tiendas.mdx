...
```mermaid
graph LR
    A["Vos<br/>(proveedor)"] -->|"1. Entregás<br/>productos"| B["Tienda<br/>(exhibe y vende)"]
    B -->|"2. Cliente<br/>compra"| C["Venta<br/>realizada"]
    C -->|"3. Liquidación<br/>mensual"| A
    B -->|"4. Devuelve<br/>lo no vendido"| A
