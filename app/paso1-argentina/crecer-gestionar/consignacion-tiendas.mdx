...
```mermaid
graph LR
    A["Vos<br/>(proveedor)"] -->|"Entregás productos"| B["Tienda<br/>(exhibe y vende)"]
    B -->|"Cliente compra"| C["Venta<br/>realizada"]
    C -->|"Liquidación mensual"| A
    B -->|"Devuelve lo no vendido"| A
