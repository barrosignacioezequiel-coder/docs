...
```mermaid
graph TD
    A["Google Maps:<br/>fábrica de calzado<br/>San Martín"] --> B["Resultado 1<br/>+ fotos + reseñas"]
    A --> C["Resultado 2<br/>+ teléfono + web"]
    A --> D["Resultado 3<br/>+ dirección exacta"]

    B --> E["Verificar en<br/>AFIP con CUIT"]
    C --> E
    D --> E

    E --> F["Llamar y<br/>consultar precios"]
