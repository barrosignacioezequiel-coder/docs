...
```mermaid
graph TD
    A["Necesito encontrar<br/>un fabricante"] --> B{"Qué necesito<br/>exactamente?"}

    B -->|"Verificar que<br/>existe legalmente"| C["Reg. Nal. Sociedades<br/>+ ARCA"]
    B -->|"Saber qué<br/>fábricas hay en un rubro"| D["RIN + Cámaras<br/>sectoriales"]
    B -->|"Encontrar al fabricante<br/>de una marca"| E["INPI<br/>buscador de marcas"]
    B -->|"Fabricantes con<br/>calidad certificada"| F["INTI"]
    B -->|"Fabricantes de<br/>equipos telecom"| G["ENACOM<br/>RAMATEL"]
    B -->|"Fábricas en<br/>una zona específica"| H["RAI/Registros<br/>provinciales"]
