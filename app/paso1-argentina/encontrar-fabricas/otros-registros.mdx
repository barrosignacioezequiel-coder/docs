...
graph TD
    ...
    B -->|Verificar que existe legalmente| C["Reg. Nal. Sociedades<br/>+ ARCA"]
    B -->|Saber qué fábricas hay en un rubro| D["RIN + Cámaras<br/>sectoriales"]
    B -->|Encontrar al fabricante de una marca| E["INPI<br/>buscador de marcas"]
    B -->|Fabricantes con calidad certificada| F["INTI"]
    B -->|Fabricantes de equipos telecom| G["ENACOM<br/>RAMATEL"]
    B -->|Fábricas en una zona específica| H["RAI/Registros<br/>provinciales"]
