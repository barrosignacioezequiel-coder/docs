...
```mermaid
graph TD
    A["Sectores<br/>cubiertos"] --> B["Construccion<br/>y materiales"]
    A --> C["Quimica e<br/>higiene"]
    A --> D["Vidrio y<br/>ceramica"]
    A --> E["Madera y<br/>muebles"]
    A --> F["Packaging<br/>y envases"]
