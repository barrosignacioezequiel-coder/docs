...
```mermaid
graph TD
    A["ANTES<br/>1-2 semanas"] --> B["DURANTE<br/>el día de la feria"]
    B --> C["DESPUÉS<br/>48 horas"]

    A --> A1["Investigar expositores"]
    A --> A2["Preparar preguntas"]
    A --> A3["Imprimir tarjetas"]

    B --> B1["Recorrer stands<br/>sistemáticamente"]
    B --> B2["Tomar notas<br/>y fotos"]
    B --> B3["Recolectar<br/>catálogos"]

    C --> C1["Seguimiento<br/>por email/teléfono"]
    C --> C2["Organizar<br/>contactos"]
    C --> C3["Comparar<br/>opciones"]
