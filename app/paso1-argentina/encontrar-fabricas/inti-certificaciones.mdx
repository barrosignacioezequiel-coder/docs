...
```mermaid
graph TD
    A["El INTI trabaja con<br/>miles de fábricas"] --> B["Certifica productos<br/>y procesos"]
    A --> C["Hace ensayos<br/>de laboratorio"]
    A --> D["Brinda asistencia<br/>técnica"]

    B --> E["Conoce fabricantes<br/>certificados por rubro"]
    C --> E
    D --> E

    E --> F["Puede orientarte<br/>hacia proveedores"]
