...
```mermaid
graph LR
    A["ArgentinaTradeNet"] --> B["Empresas verificadas<br/>por Cancillería"]
    A --> C["Foco en exportadores<br/>= mayor formalidad"]
    A --> D["Información<br/>más completa"]

    E["Guía Industrial<br/>Argentina"] --> F["Auto-registro<br/>sin verificación"]
    E --> G["Todo tipo de empresa<br/>= mayor variedad"]
    E --> H["Información<br/>variable"]
