...
```mermaid
graph TD
    A["Identificar parques<br/>en tu zona o rubro"] --> B["Consultar directorio<br/>nacional de parques"]
    B --> C["Contactar<br/>administración del parque"]
    C --> D["Pedir listado de<br/>empresas radicadas"]
    D --> E["Filtrar por rubro<br/>que te interesa"]
    E --> F["Contactar fábricas<br/>individualmente"]
