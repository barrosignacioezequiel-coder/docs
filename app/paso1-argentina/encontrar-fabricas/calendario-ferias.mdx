...
```mermaid
graph LR
    A["Ene-Feb<br/>Planificación"] --> B["Mar-Abr<br/>Expoagro<br/>EMITEX"]
    B --> C["May-Jun<br/>FIMAQH<br/>Automechanika"]
    C --> D["Jul<br/>Receso"]
    D --> E["Ago-Sep<br/>ARMINERA<br/>Expo Industria"]
    E --> F["Oct-Nov<br/>FITEMA<br/>Ferias regionales"]
    F --> G["Dic<br/>Cierre"]

    style A fill:#ff9800,stroke:#e65100,color:#fff
    style B fill:#4caf50,stroke:#2e7d32,color:#fff
    style C fill:#4caf50,stroke:#2e7d32,color:#fff
    style D fill:#f5f5f5,stroke:#9e9e9e,color:#fff
    style E fill:#4caf50,stroke:#2e7d32,color:#fff
    style F fill:#4caf50,stroke:#2e7d32,color:#fff
    style G fill:#f5f5f5,stroke:#9e9e9e,color:#fff
```
