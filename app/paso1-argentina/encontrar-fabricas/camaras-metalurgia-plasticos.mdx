...
```mermaid
graph TD
    A["Buscas un producto<br/>metalico?"] --> B["Contactar ADIMRA<br/>(adimra.org.ar)"]
    B --> C["Describir el<br/>producto que necesitas"]
    C --> D["ADIMRA te indica<br/>la sub-camara"]
    D --> E["Contactar la<br/>sub-camara especifica"]
    E --> F["Pedir directorio<br/>de fabricantes"]
    F --> G["Contactar fabricas<br/>y pedir cotizacion"]
