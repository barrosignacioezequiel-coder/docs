...
```mermaid
graph LR
    A["Una fábrica<br/>crea un producto"] --> B["Registra la marca<br/>en el INPI"]
    B --> C["El INPI guarda<br/>nombre del titular"]
    C --> D["Vos buscás la marca<br/>y encontrás al fabricante"]
