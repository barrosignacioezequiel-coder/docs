...
```mermaid
graph TD
    A["Entrás a<br/>guiaindustrial.com.ar"] --> B["Buscás:<br/>calzado"]
    B --> C["Filtrás por:<br/>Buenos Aires"]
    C --> D["Obtenés lista<br/>de empresas"]
    D --> E["Revisás fichas<br/>una por una"]
    E --> F["Anotás las que<br/>fabrican lo que buscás"]
    F --> G["Contactás por<br/>teléfono o email"]
