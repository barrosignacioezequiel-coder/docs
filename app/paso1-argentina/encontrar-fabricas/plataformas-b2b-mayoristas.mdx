...
```mermaid
graph LR
    A["MercadoLibre"] --> B["Mezcla minorista<br/>y mayorista"]
    A --> C["Comisión alta<br/>(hasta 30%)"]
    A --> D["Cualquiera<br/>puede vender"]

    E["Plataformas B2B"] --> F["Solo venta<br/>mayorista"]
    E --> G["Comisiones más<br/>bajas o sin comisión"]
    E --> H["Vendedores<br/>verificados"]
