...
```mermaid
graph TD
    A["Visitás<br/>una feria"] --> B["Ves productos<br/>en persona"]
    A --> C["Hablás con<br/>vendedores"]
    A --> D["Comparás<br/>opciones"]
    A --> E["Recolectás<br/>catálogos"]

    B --> F["Evaluás calidad<br/>sin comprar"]
    C --> F
    D --> F
    E --> F

    F --> G["Contactás después<br/>con información real"]
