...
```mermaid
graph TD
    A["Abrir Google Maps"] --> B["Ubicar zona<br/>industrial"]
    B --> C["Buscar 'fábrica de<br/>[producto]'"]
    C --> D["Revisar fichas<br/>de resultados"]
    D --> E["Verificar con<br/>Street View"]
    E --> F["Anotar teléfono<br/>y dirección"]
