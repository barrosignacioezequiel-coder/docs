...
```mermaid
graph TD
    A["Organizador convoca<br/>fabricantes y compradores"] --> B["Se arma agenda<br/>de reuniones"]
    B --> C["Día del evento:<br/>reuniones de 15-20 min"]
    C --> D["Comprador se reúne<br/>con 8-15 fabricantes"]
    D --> E["Intercambio de datos<br/>y muestras"]
    E --> F["Seguimiento posterior:<br/>negociación real"]
