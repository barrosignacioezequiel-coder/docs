...
```mermaid
graph TD
    A["Definir qué<br/>producto buscás"] --> B["Identificar el<br/>rubro/sector"]
    B --> C["Buscar la cámara<br/>sectorial del rubro"]
    C --> D["Consultar directorios<br/>industriales"]
    D --> E["Cruzar con registros<br/>oficiales"]
    E --> F["Verificar legitimidad<br/>de cada fábrica"]
    F --> G["Armar lista corta<br/>de 3-5 candidatas"]
