...
```mermaid
graph TD
    A["Buscar producto<br/>en MercadoLibre"] --> B["Filtrar por<br/>vendedor mayorista"]
    B --> C["Analizar perfil<br/>del vendedor"]
    C --> D{"Es fabricante<br/>real?"}
    D -->|Sí| E["Buscar datos<br/>de contacto"]
    D -->|No| F["Descartar y<br/>seguir buscando"]
    E --> G["Contactar por<br/>fuera de ML"]
    G --> H["Negociar precio<br/>mayorista"]
