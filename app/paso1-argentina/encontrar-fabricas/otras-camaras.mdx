...
```mermaid
graph TD
    A["No encontras la<br/>camara de tu sector?"] --> B["Buscar en RUMP"]
    A --> C["Preguntar a CAME"]
    A --> D["Google con<br/>formula especifica"]
    B --> E{"Encontraste?"}
    C --> E
    D --> E
    E -- Si --> F["Contactar la<br/>camara y pedir<br/>directorio"]
    E -- No --> G["Contactar UIA<br/>como ultimo recurso"]
    G --> F
