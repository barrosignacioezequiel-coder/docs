...
```mermaid
graph TD
    A["Sos Responsable<br/>Inscripto?"] -- Sí --> B["Comprás a<br/>fábrica RI?"]
    A -- No, soy<br/>Monotributista --> C["El IVA no te<br/>afecta: no lo<br/>discriminás"]
    B -- Sí, Factura A --> D["Tomás el IVA<br/>como crédito fiscal<br/>= no es costo"]
    B -- No, Factura C --> E["Pagás el IVA<br/>pero NO lo<br/>recuperás = costo real"]
