...
```mermaid
graph TD
    A["Tu negocio de<br/>reventa"] --> B["ARCA (ex-AFIP)<br/>Impuestos nacionales"]
    A --> C["IIBB Provincial<br/>Ingresos Brutos"]
    A --> D["MercadoLibre<br/>Políticas de plataforma"]
    A --> E["Organismos específicos<br/>ANMAT, SENASA, INTI"]
    A --> F["Municipalidad<br/>Habilitaciones locales"]
    B --> G["Monotributo / RI<br/>IVA, Ganancias"]
    C --> H["Alícuotas por<br/>provincia y actividad"]
    D --> I["Comisiones, envíos,<br/>reglas de publicación"]
```
