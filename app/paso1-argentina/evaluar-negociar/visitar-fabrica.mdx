...
```mermaid
graph LR
    A["Contacto inicial<br/>por teléfono/email"] --> B["Verificación<br/>de legitimidad"]
    B --> C["Evaluación de<br/>muestras y precios"]
    C --> D["VISITA<br/>presencial"]
    D --> E["Decisión<br/>de compra"]
