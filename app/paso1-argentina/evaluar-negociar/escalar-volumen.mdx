...
```mermaid
graph TD
    A["Mes 1-3<br/>100 unidades/mes<br/>Probar producto y mercado"] --> B["Mes 4-6<br/>200 unidades/mes<br/>Validar demanda sostenida"]
    B --> C["Mes 7-12<br/>500 unidades/mes<br/>Optimizar márgenes"]
    C --> D["Año 2<br/>1,000+ unidades/mes<br/>Negociar condiciones premium"]
