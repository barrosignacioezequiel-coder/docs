...
```mermaid
graph TD
    A["¿Qué tipo de operación es?"] --> B{"Compra puntual<br/>menos de ARS 200K"}
    A --> C{"Compras recurrentes<br/>relación establecida"}
    A --> D{"Pedido grande<br/>más de ARS 500K"}
    A --> E{"Exclusividad o<br/>producto a medida"}

    B --> F["Email de confirmación<br/>es suficiente"]
    C --> G["Orden de compra<br/>por cada pedido"]
    D --> H["Acuerdo de provisión<br/>recomendable"]
    E --> I["Contrato formal<br/>con abogado"]
