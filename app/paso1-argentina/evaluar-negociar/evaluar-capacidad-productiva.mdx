...
```mermaid
graph TD
    A["La fábrica tiene<br/>stock permanente?"] -- Sí --> B["Entrega<br/>en 1-5 días"]
    A -- No, produce<br/>sobre pedido --> C["Lead time<br/>7-30 días"]
    B --> D["Ventaja: rapidez<br/>Desventaja: productos estándar"]
    C --> E["Ventaja: personalización<br/>Desventaja: planificar con anticipación"]
```
