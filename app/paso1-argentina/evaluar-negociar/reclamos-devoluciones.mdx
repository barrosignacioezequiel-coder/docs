...
graph TD
    ...
    B -- "Rápido, empático,<br/>con solución" --> C["Cliente sorprendido<br/>positivamente"]
    C --> D["Review positiva<br/>actualizada"]
    D --> E["Cliente que vuelve<br/>a comprarte"]
    B -- "Lento, defensivo,<br/>sin solución" --> F["Cliente enojado"]
    F --> G["Review negativa<br/>permanente"]
    G --> H["Otros compradores<br/>ven la review y no compran"]
```
