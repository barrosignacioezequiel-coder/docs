...
```mermaid
graph TD
    A["Preparacion<br/>Cotizar 3+ fabricas<br/>Conocer precios de mercado"] --> B["Preguntar<br/>Pedir lista de precios<br/>Consultar condiciones"]
    B --> C["Escuchar<br/>Entender la posicion<br/>de la fabrica"]
    C --> D["Contrapropuesta<br/>Proponer alternativas<br/>que beneficien a ambos"]
    D --> E["Acuerdo<br/>Cerrar condiciones<br/>que funcionen para los dos"]
    E --> F["Confirmar por escrito<br/>Email o WhatsApp<br/>con todo detallado"]
