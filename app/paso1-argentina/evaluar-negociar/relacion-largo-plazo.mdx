...
```mermaid
graph LR
    A["Compra inicial<br/>Probar la relación"] --> B["Pedidos regulares<br/>Confianza creciente"]
    B --> C["Beneficios de lealtad<br/>Mejores condiciones"]
    C --> D["Desarrollo conjunto<br/>Productos con tu marca"]
